...
//        head = null;
    ...
    public void add(int index,E e){
        if (index<0||index>size){
            throw new  IllegalArgumentException("Add failer.Illegal index");
        }
...
//        size ++;
    ...
    public E remove(int index){
        if (index<0||index>size){
            throw new  IllegalArgumentException("Remove failer.Index is illegal");
        }
    ...
    public boolean removeElement(E e){
        ...
        Node prve = dummyHead;
        while (prve.next != null && !prve.next.e.equals(e)){
            prve = prve.next;
        }
        if (prve.next != null){
